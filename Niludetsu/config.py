...
TEMPROOM_CATEGORY: int | None = (
    1414740540314091621  # категория, куда складываются временные голосовые
)
TEMPROOM_CHANNEL: int | None = (
    1422520098534592553  # текстовый канал, где висит интерфейс
)
TEMPROOM_VOICE: int | None = (
    1422520569181765795  # лобби/кнопка: заходишь — создаётся персональный канал
)
TEMPROOM_MESSAGE: int | None = (
    1425605817947783239  # ID сообщения с меню управления (если None — пропускаем привязку)
)
...
OPTIONAL_ROLES = [
    {
        "id": 1364498609340416040,
        "name": "Новости",
        "description": "Уведомления о новостях",
        "emoji": "📰",
    },
    {
        "id": 1364498617758388245,
        "name": "Розыгрыши",
        "description": "Уведомления о розыгрышах",
        "emoji": "🎁",
    },
]
