        ...
        "command_list": [
            {
                "name": "balance",
                "aliases": ["b"],
                "description": "Показать информацию о балансе",
                "required_args": [],
                "optional_args": ["юзер"],
            ...
            },
            {
                "name": "blackjack",
                "aliases": ["bj"],
                "description": "Сыграть в блекджек",
                "required_args": ["ставка"],
                "optional_args": [],
                "type": CommandType.HYBRID,
            },
            {
            ...
            },
            {
                "name": "income",
                "aliases": [],
                "description": "Получить доход с ролей",
                "required_args": [],
                "optional_args": [],
                "type": CommandType.HYBRID,
            },
            ...
            },
            {
                "name": "shop",
                "aliases": [],
                "description": "Открыть магазин ролей",
                "required_args": [],
                "optional_args": [],
                "type": CommandType.HYBRID,
            },
            {
                "name": "slut",
                "aliases": [],
                "description": "Рискованный способ заработка",
                "required_args": [],
                "optional_args": [],
                "type": CommandType.HYBRID,
            },
            ...
            },
            {
                "name": "withdraw",
                "aliases": ["wd"],
                "description": "Вывести деньги с банковского счёта",
                "required_args": [],
                "optional_args": ["сумма"],
                "type": CommandType.HYBRID,
            },
            {
                "name": "withdrawfamily",
                "aliases": [],
                "description": "Снять деньги с семейного счета",
                "required_args": [],
                "optional_args": ["сумма"],
                "type": CommandType.HYBRID,
            },
            {
                "name": "work",
                "aliases": [],
                "description": "Заработать кривены",
                "required_args": [],
                "optional_args": [],
                "type": CommandType.HYBRID,
            },
        ...
        "command_list": [
            {
                ...
                "required_args": ["вопрос"],
                "optional_args": [],
                "type": CommandType.PREFIX,
            },
            {
                "name": "nsfw",
                "aliases": ["rnsfw", "realnsfw"],
                "description": "Сам играйся со своим причандалом",
                "required_args": [],
                "optional_args": [],
                "type": CommandType.HYBRID,
            },
    ...
    "moderation": {
        ...
        "command_list": [
            ...
            },
            {
                "name": "massrole",
                "aliases": [],
                "description": "Массовая выдача ролей",
                "required_args": ["role"],
            ...
            },
            {
                ...
                "required_args": ["user"],
                "optional_args": ["duration", "reason"],
                "type": CommandType.HYBRID,
            },
            {
                "name": "rudiments",
                "aliases": [],
                "description": "Посмотреть список наказаний пользователя",
                "required_args": [],
                "optional_args": ["user"],
                "type": CommandType.HYBRID,
            },
            {
                "name": "slowmode",
                "aliases": [],
                "description": "Установить медленный режим",
            ...
            },
            {
                "name": "unmute",
                "aliases": [],
                "description": "Снять заглушку с пользователя",
                "required_args": ["user"],
                "optional_args": ["reason"],
                "type": CommandType.HYBRID,
            },
    ...
    "profile": {
        ...
        "command_list": [
            ...
            },
            {
                "name": "avatar",
                "aliases": ["аватар"],
                "description": "Показать аватарку пользователя",
                "optional_args": ["lgbt"],
                "type": CommandType.HYBRID,
            },
            {
                "name": "child",
                "aliases": ["усыновить", "удочерить", "ребенок"],
                "description": "Усыновить пользователя",
                "required_args": ["user"],
                "optional_args": [],
                "type": CommandType.HYBRID,
            },
            {
                "name": "divorce",
                "aliases": ["развестись", "расторгнуть", "развод"],
            ...
            {
                "name": "kidshouse",
                "aliases": ["детдом", "отказаться", "отпустить"],
                "description": "Отпустить усыновленного пользователя",
                "required_args": ["user"],
                "optional_args": [],
                "type": CommandType.HYBRID,
            },
            ...
            {
                "name": "marry",
                "aliases": ["предложение", "женитьба", "свадьба", "жениться"],
                "description": "Сделать предложение пользователю",
                "required_args": ["user"],
                "optional_args": [],
                "type": CommandType.HYBRID,
            },
            {
                "name": "relations",
                "aliases": ["брак", "отношения"],
                "description": "Показать сколько времени вы с партнером вместе",
                "required_args": [],
                "optional_args": ["user"],
                "type": CommandType.HYBRID,
            },
        ...
        "command_list": [
            {
                "name": "anal",
                "aliases": ["анал"],
                "description": "Заняться анальным сексом (NSFW)",
                "required_args": ["user"],
                "type": CommandType.HYBRID,
            },
            {
                "name": "bite",
                "aliases": ["укусить", "кусь", "кусать"],
            ...
            },
            {
                "name": "blowjob",
                "aliases": ["минет"],
                "description": "Сделать минет (NSFW)",
                "required_args": ["user"],
                "type": CommandType.HYBRID,
            },
            {
                "name": "cry",
                "aliases": ["плакать", "реветь", "рыдать"],
            ...
            },
            {
                "name": "cum",
                "aliases": ["кончить"],
                "description": "Кончить на пользователя (NSFW)",
                "required_args": ["user"],
                "type": CommandType.HYBRID,
            },
            {
            ...
            {
                "name": "fuck",
                "aliases": ["выебать", "трахнуть"],
                "description": "Выебать пользователя (NSFW)",
                "required_args": ["user"],
                "type": CommandType.HYBRID,
            },
            {
                "name": "hug",
                "aliases": ["обнять", "обнимашки", "обнимать"],
            ...
            {
                "name": "kiss",
                "aliases": ["поцеловать", "чмок", "поцелуй"],
            ...
            {
                "name": "pussylick",
                "aliases": ["куни", "куннилингус"],
                "description": "Сделать куннилингус (NSFW)",
                "required_args": ["user"],
                "type": CommandType.HYBRID,
            },
            {
                "name": "sex",
                "aliases": ["заняться", "секс"],
                "description": "Заняться любовью с пользователем (NSFW)",
                "required_args": ["user"],
                "type": CommandType.HYBRID,
            },
            {
                "name": "slap",
                "aliases": ["ударить", "шлепнуть", "шлёпнуть"],
            ...
            {
                "name": "sneeze",
                "aliases": ["чихнуть", "апчхи", "чих"],
                "description": "Чихнуть",
                "type": CommandType.HYBRID,
            },
            {
                "name": "solo",
                "aliases": ["мастурбация", "мастурбировать"],
                "description": "Мастурбировать (NSFW)",
                "required_args": [],
                "type": CommandType.HYBRID,
            },
            {
                "name": "sorry",
                "aliases": ["извиниться"],
                "description": "Извиниться перед пользователем",
                "required_args": ["user"],
                "type": CommandType.HYBRID,
            },
            {
                "name": "tickle",
                "aliases": ["щекотать", "пощекотать", "щекотка"],
        ...
        "command_list": [
            {
                "name": "ascii",
                "aliases": [],
                "description": "Создать ASCII арт из текста",
                "required_args": ["текст"],
                "optional_args": ["шрифт"],
                "type": CommandType.PREFIX,
            },
            ...
            },
            {
                "name": "hash",
                "aliases": [],
                "description": "Получить хеш текста (MD5, SHA256)",
                "required_args": ["текст"],
                "optional_args": ["алгоритм"],
                "type": CommandType.PREFIX,
            },
            {
                "name": "k",
            ...
            },
            {
                "name": "ping",
                "aliases": [],
                "description": "Проверить пинг до сервера",
                "type": CommandType.PREFIX,
            },
            {
                "name": "rand",
            ...
            },
            {
                "name": "screenshot",
                "aliases": ["скрин", "ss"],
                "description": "Создать скриншот веб-страницы",
                "required_args": ["url"],
                "optional_args": [],
                "type": CommandType.PREFIX,
            },
            ...
            },
            {
                "name": "whois",
                "aliases": [],
                "description": "Информация о домене/IP адресе",
                "type": CommandType.PREFIX,
            },
            {
                "name": "afk",
    ...
    "admin": {
        ...
        "command_list": [
            ...
            },
            {
                "name": "bump",
                "aliases": [],
                "description": "Получение текущего времени для bump-команды",
                "type": CommandType.PREFIX,
            },
            {
                "name": "giveaway",
            ...
            },
            {
                "name": "partnership",
                "aliases": [],
                "description": "Статистика партнерства",
                "required_args": [],
            ...
            },
            {
                "name": "rewards",
                "aliases": [],
                "description": "Управление наградами сервера для партнёр-менеджеров",
                "type": CommandType.PREFIX,
            },
        ],
    },
...
def get_command_registry() -> Dict[str, Dict[str, object]]:
    ...
    for data in registry.values():
        ...
        commands.sort(key=lambda item: str(item.get("name", "")))
    return registry
